...
set genomeRtd $env(RT_TMP)/2189B020.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Deparser_t_EngineStage_0_Editor__GB1}]"
...
set genomeName [subst -nocommands -novariables {Deparser_t_EngineStage_0_Editor__GB1}]
