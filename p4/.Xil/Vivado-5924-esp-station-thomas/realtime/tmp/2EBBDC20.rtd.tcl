...
set genomeRtd $env(RT_TMP)/2EBBDC20.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {XilinxSwitch__GCB0}]"
...
set genomeName [subst -nocommands -novariables {XilinxSwitch__GCB0}]
