...
set genomeRtd $env(RT_TMP)/28EE9AE8.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Deparser_t_EngineStage_2__GC0}]"
...
set genomeName [subst -nocommands -novariables {Deparser_t_EngineStage_2__GC0}]
