...
set genomeRtd $env(RT_TMP)/247C1D70.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Deparser_t_Engine__GC0}]"
...
set genomeName [subst -nocommands -novariables {Deparser_t_Engine__GC0}]
