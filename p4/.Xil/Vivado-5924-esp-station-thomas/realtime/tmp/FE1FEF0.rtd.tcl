...
set genomeRtd $env(RT_TMP)/FE1FEF0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Parser_t_Engine__GB0}]"
...
set genomeName [subst -nocommands -novariables {Parser_t_Engine__GB0}]
