...
set genomeRtd $env(RT_TMP)/10332B58.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Parser_t_EngineStage_3}]"
...
set genomeName [subst -nocommands -novariables {Parser_t_EngineStage_3}]
